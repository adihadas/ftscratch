...
var Lang = {
	...
	trans: {
		...
		ar: {
			...
			doSetMotorSpeed: 'عرّف المحرك %m.motors للسرعة %n',
			doSetMotorSpeedDir: 'عرّف المحرك %m.motors إلى %n %m.motorDirections',
			doSetMotorDir: 'عرّف المحرك %m.motors إلى %m.motorDirections',
	...
	// get the arab translated version
	get: function(what) {
