...
var Lang = {
	...
	trans: {
		...
		en: {
			...
			doPlaySound: '%n נגן צליל',
			doPlaySoundWait: '%n נגן צליל עד לסיום',
			doSetLamp: '%m.outputs -ל %n קבע ערך נורה',
			doSetOutput: '%m.outputs -ל %n קבע ערך פלט',
			doResetCounter: '%m.counters אתחל מונה',
			doSetMotorSpeed:'%n -ל %m.motors קבע ערך מנוע',
			doSetMotorSpeedDir: '%m.motorDirections %n -ל %m.motors קבע ערך מנוע',
			doSetMotorDir: '%m.motorDirections לכיוון %m.motors  קבע ערך מנוע',
			doSetMotorSpeedDirDist: '%m.motorDirections %n צעדים עם הערך %n -ב %m.motors הזז מנוע',
