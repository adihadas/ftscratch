...
*/
    ...
    var blocks = {
	he: [
		 	["h", "בלחיצת כפתור %m.buttons", "button","מרכזי"],
            ...
            ["w", "פנה %n במשך %n ש", "scratch_turn_with_time", 90,1],
 ...
 //           [" ", "שנה צבע אור %n on %m.light", "scratch_change_leds", 0, "הכל"],
 ...
 //           [" ", "leds sound %n", "V_leds_sound", 32],
            ...
            [" ", "נגן תו %n במשך %n ש", "A_sound_freq", 440, 1],
 //           [" ", "play sound SD %n", "A_sound_play_sd", ""],
 //           [" ", "הקלט צליל לכרטיס הזיכרון %n", "A_sound_record", ""],
 //           [" ", "נגן צליל מכרטיס הזכרון %n", "A_sound_replay", ""],
 //           ["r", "אחזר ערך חיישן קרבה %n", "proximity", 2],
            ["r", "אחזר ערך חיישן קרבה %m.proxsensors", "proximity2", "front far left"],
 //           ["r", "proximity sensors", "prox_horizontal"],
            ["r", "אחזר ערך חיישן רצפה %n", "רצפה", 0],
...
//            ["b", "touching %m.sensors %n", "touching_threshold", "front"],
            ["r", "אחזור רמת ווליום", "mic_intensity"],
            ["b", "האם זוהה צליל", "sound_detected"],
            ["b", "האם זוהתה טפיחה %n", "bump"],
            ["r", "אחזר זווית הטיה %m.tilts", "tilt", "front-back"],
            ["r", "אחזר טמפרטורה", "temperature"],
            ["r", "אחזר מהירות מנוע %m.leftright", "motor", "left"],
...
//            ["r", "receive", "receive"]
           ...
           /* 
            ["r", "אחזר מהירות מנוע %m.leftright", "motor_speed", "שמאל" ],
    ...
    var menus = {
	        he: {
            leftrightall: ["שמאל", "ימין", "הכל"],
            leftright: ["שמאל", "ימין"],
            sensors: ["קדימה", "אחורה", "רצפה"],
            proxsensors: ["קדימה-שמאל-קיצוני", "קדימה-שמאל", "קדימה-מרכז", "קדימה-ימין", "קדימה-ימין-קיצוני", "אחורה-שמאל", "אחורה-ימין"],
            singlelight: ["למעלה", "למטה-שמאל", "למטה-ימיןt"],
            light: ["הכל", "למעלה", "למטה", "למטה-שמאל", "למטה-ימין"],
            angles: ["קדימה", "אחורה", "רצפה"],
            sounds: ["0", "1", "2", "3", "4", "5", "6", "7"],
            odo: ["כיוון", "x", "y"],
            tilts: ["קדימה-אחורה", "מעלה-מטה", "ימינה-שמאלה"],
