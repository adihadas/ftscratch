...
var Lang = {
	...
	trans: {
		...
		en: {
			...
			onInput: 'של ערך אם %m.inputSensors %m.inputs %m.compares %n',
			...
			dir_forward: 'קדימה',
			dir_backwards: 'אחורה',
			sens_color: 'צבע חיישן',
			sens_distance: 'מרחק חיישן',
			sens_ntc: 'NTC התנגדות',
			sens_photo: 'Photo התנגדות',
			sens_lightBarrier: 'אור מחסום',
			sens_button: 'מתג',
			sens_reed: 'מגנטיות חיישן',
			openclose_opens: 'נפתח',
			openclose_closes: 'נסגר',
			mode_a5k: 'אנלוגית התנגדות',
			mode_d5k: 'דיגיטלית התנגדות',
			mode_a10v: 'אנלוגי מתח',
			mode_d10v: 'דיגיטלי מתח',
