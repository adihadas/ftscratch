...
var Lang = {
	...
	trans: {
		...
		en: {
			...
			onCounter: 'אם counter %m.counters %m.compares %n',
			onInput: 'אם ערכו של %m.inputSensors %m.inputs %m.compares %n',
			...
			doPlaySoundWait: 'נגן צליל עד לסיום %n',
			doSetLamp: 'קבע ערך נורה %m.outputs to %n',
			doSetOutput: 'קבע ערך פלט %m.outputs to %n',
			doResetCounter: 'אתחל מונה %m.counters',
			doSetMotorSpeed: 'קבע ערך מנוע %m.motors to %n',
			doSetMotorSpeedDir: 'קבע ערך מנוע %m.motors to %n %m.motorDirections',
			doSetMotorDir: 'קבע ערך מנוע %m.motors to %m.motorDirections',
			doSetMotorSpeedDirDist: 'הזז מנוע %m.motors ב- %n צעדים עם %n %m.motorDirections',
			doSetMotorSpeedDirSync: 'הזז מנוע %m.motors יחד עם %m.motors עם %n %m.motorDirections',
			doSetMotorSpeedDirDistSync: 'הזז מנוע %m.motors עם %m.motors ב- %n צעדים עם %n %m.motorDirections',
			doStopMotor: 'עצור מנוע %m.motors',
			doConfigureInput: 'הגדר קלט %m.inputs עבור %m.inputModes',
			dir_forward: 'קדימה',
			dir_backwards: 'אחורה',
			sens_color: 'חיישן צבע',
			sens_distance: 'חיישן מרחק',
			sens_ntc: 'התנגדות NTC',
			sens_photo: 'התנגדות פוטו',
			sens_lightBarrier: 'מחסום אור',
			sens_button: 'מתג',
			sens_reed: 'חיישן מגנטיותt',
			openclose_opens: 'פותח',
			openclose_closes: 'סוגר',
